...
/**
  Moin GUI main class. This class represents the main window of the Moin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class MoinGUI : public QMainWindow
{
    Q_OBJECT
public:
    explicit MoinGUI(QWidget *parent = 0);
    ~MoinGUI();
