...
var sendPage = (function($) {
    ...
    function changeTransactionType(event) {
        ...
        $("#spend_moin")   .toggle(from_type === "public");
        $("#spend_moinX").toggle(from_type === "private");

        $("#to_moin")      .toggle(to_type === "public");
        $("#to_moinX")   .toggle(to_type === "private");

        $("#to_balance").toggle(!main);

        // TODO: Fix coin control for MOIN -> MOINX
    ...
    function getTransactionType() {
        ...
        if (from_public)
            return +!to_public; // 0 (MOIN_TO_MOIN) or 1 (MOIN_TO_ANON)
        else
            return 2 + to_public; // 2 (ANON_TO_ANON) or 3 (ANON_TO_MOIN)
    }
