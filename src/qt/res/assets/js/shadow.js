function invalid(e, t) {
    return t === !0 ? e.css("background", "").css("color", "") : e.css("background", "#0CCEFD").css("color", "white"), 1 == t
}
...
function getIconTitle(e) {
    return "unverified" == e ? "fa fa-cross " : "verified" == e ? "fa fa-check " : "contributor" == e ? "fa fa-cog " : "mointeam" == e ? "fa fa-code " : ""
}
...
function dumpStrings() {
    function e(e) {
        return 'QT_TRANSLATE_NOOP("MoinBridge", "' + e + '"),\n'
    }
    var t = "";
...
var base58 = {
    ...
    unit = {
        ...
        setType: function(e) {
            switch (this.type = void 0 == e ? 0 : e, e) {
                case 1:
                    this.name = "mMOIN", this.display = "mMOIN";
                    break;
                case 2:
                    this.name = "uMOIN", this.display = "&micro;MOIN";
                    break;
                case 3:
                    this.name = "sMOIN", this.display = "Moinlet";
                    break;
                default:
    ...
    overviewPage = {
        init: function() {
            this.balance = $(".balance"), this.moinXBal = $(".moinX_balance"), this.reserved = $("#reserved"), this.stake = $("#stake"), this.unconfirmed = $("#unconfirmed"), this.immature = $("#immature"), this.total = $("#total")
        },
        updateBalance: function(e, t, a, s, n) {
            void 0 == e ? (e = this.balance.data("orig"), t = this.moinXBal.data("orig"), a = this.stake.data("orig"), s = this.unconfirmed.data("orig"), n = this.immature.data("orig")) : (this.balance.data("orig", e), this.moinXBal.data("orig", t), this.stake.data("orig", a), this.unconfirmed.data("orig", s), this.immature.data("orig", n)), this.formatValue("balance", e), this.formatValue("moinXBal", t), this.formatValue("stake", a), this.formatValue("unconfirmed", s), this.formatValue("immature", n), this.formatValue("total", e + a + s + n + t)
        },
    ...
    verified_list = {
        MrKUwvoysd5iXu5ZraFAvL4BxDd8LprS3A: {
            username: "kingcaper",
            title: "MOINteam",
            custom_avatar: !1
        },
        MfsP6vYPumaucmvRGYBvmEgjJoPMsRGL7P: {
            username: "crz",
            title: "MOINteam",
            custom_avatar: !1
        },
        MahQkniNvYHmazbYr1zhRwpXkG7frFAndg: {
            username: "jookly",
            title: "MOINteam",
            custom_avatar: !1
        },
        MgtvpgPioPNCoQVqd6iLeQ2hMqnzMnCHpu: {
            username: "axllht",
            title: "MOINteam",
            custom_avatar: !1
        },
        Mr8Eeidgr6vrUcfms2pcCoMEShomzaxKPU: {
            username: "kopykat",
            title: "contributor",
            custom_avatar: !1
        }
