...
QString TransactionRecord::getTypeLabel(const int &type)
{
    ...
    case RecvWithAddress:
        return MoinGUI::tr("Received with");
    case RecvFromOther:
        return MoinGUI::tr("Received from");
    case SendToAddress:
    case SendToOther:
        return MoinGUI::tr("Sent to");
    case SendToSelf:
        return MoinGUI::tr("Payment to yourself");
    case Generated:
        return MoinGUI::tr("Mined");
    case RecvMoinX:
        return MoinGUI::tr("Received MOINX");
    case SendMoinX:
        return MoinGUI::tr("Sent MOINX");
    case Other:
        return MoinGUI::tr("Other");
    default:
        return "";
    }
}
    ...
    } else
    {
        ...
        BOOST_FOREACH(const CTxIn& txin, wtx.vin)
        {
                ...
                && txin.IsAnonInput())
            {
                ...
                {
                    fAllFromMe = false;
                    break; // display as send/recv moin 
                };
                continue;
            };
