...
void OptionsModel::Init()
{
    ...
    nDisplayUnit = settings.value("nDisplayUnit", BitcoinUnits::MOIN).toInt();
    ...
    fAutoRedeemMoinX = settings.value("fAutoRedeemMoinX", false).toBool();
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case AutoRedeemMoinX:
            return fAutoRedeemMoinX;
        case MinRingSize:
            return nMinRingSize;
        case MaxRingSize:
            return nMaxRingSize;
...
QString OptionsModel::optionIDName(int row)
{
    ...
    case AutoRedeemMoinX: return "AutoRedeemMoinX";
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DisplayAddresses:
            ...
            emit displayUnitChanged(settings.value("nDisplayUnit", BitcoinUnits::MOIN).toInt());
            break;
        case DetachDatabases: {
        ...
        case AutoRingSize: {
            ...
            break;
        case AutoRedeemMoinX: {
            fAutoRedeemMoinX = value.toBool();
            settings.setValue("fAutoRedeemMoinX", fAutoRedeemMoinX);
            }
            break;
        case MinRingSize: {
...
bool OptionsModel::getAutoRedeemMoinX() { return fAutoRedeemMoinX; }
