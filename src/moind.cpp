    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
        {
            ...
            std::string strUsage = _("MOIN version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  moind [options]                     " + "\n" +
                  "  moind [options] <command> [params]  " + _("Send command to -server or moind") + "\n" +
                  "  moind [options] help                " + _("List commands") + "\n" +
                  "  moind [options] help <command>      " + _("Get help for a command") + "\n";
        ...
        for (int i = 1; i < argc; i++)
            if (!IsSwitchChar(argv[i][0]) && !boost::algorithm::istarts_with(argv[i], "moin:"))
                fCommandLine = true;
